...
//==============================================================================================
//  1) DESCRIPTION
//    FilterDate — a single bounded date input for a se_date-style column filter, clamped
//    between EARLIEST_DATA_DATE and today. Instantiated twice (from/to) wherever a date-range
//    filter is needed, rather than one component per range.
//
//    Parameters:
//      value         — current ISO date string
//      onChange      — called with the new date string
//      overrideClass — classes merged over DEFAULT_CLASS (default WIDTH_DATE)
//==============================================================================================
